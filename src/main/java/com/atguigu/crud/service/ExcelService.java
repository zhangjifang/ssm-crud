...
public class ExcelService {
   private final static String xls = "xls";
     ...
     * @throws IOException
     */
    public static List<String[]> readExcel(FileItem file) throws IOException{
        //检查文件
        checkFile(file);
        //获得Workbook工作薄对象
...
//                    String[] cells = new String[row.getPhysicalNumberOfCells()];
    ...
    public static void checkFile(FileItem file) throws IOException{
        //判断文件是否存在
        if(null == file){
    ...
    public static Workbook getWorkBook(FileItem file) {
        //获得文件名
        String fileName = file.getName();
