...
public class BorrowInfoService {
	...
	public List<BorrowInfo> getbyStudentID(String studentid){
		// TODO Auto-generated method stub
		//return studentProfessionMapper.selectByExample(null);
		BorrowInfoExample borrowInfoExample=new BorrowInfoExample();
		Criteria criteria=borrowInfoExample.createCriteria();
		criteria.andStudentidEqualTo(studentid);
		return borrowInfoMapper.selectByExample(borrowInfoExample);
	}
